...
import as.pa2.loadbalancer.availability.SerialPing;
...
public class LoadBalancer extends AbstractLoadBalancer {
    ...
    public LoadBalancer() {
        ...
        this.ping = new SerialPing();
        setRule(DEFAULT_RULE);
        setupPingTask();
    }
    
    public LoadBalancer(String name, IFRule rule, IFPing ping, IFPingStrategy pingStrategy) {
        this.name = name;
        this.ping = ping;
